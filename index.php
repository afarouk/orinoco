...
<head>
  ...
  ================================================== -->
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, initial-scale=1.0">
...
<body id="page-top">
        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">
                    <img src="img/orinocoLogo.png" class="img-responsive" alt="">
                </a>
            </div>
            ...
            <div class="row text-center content-row">
                <div class="col-md-3 col-sm-6 wow fadeIn" data-wow-delay=".2s">
                    <div class="about-content">
                        ...
                        <div class="feature_icon">
              						<img src="img/no_app_icon.png" class="center-block img-responsive"></img>
              					</div>
                        <h3>No appstore </h3>
                ...
                <div class="col-md-3 col-sm-6 wow fadeIn" data-wow-delay=".6s">
                    <div class="about-content">
                        ...
                        <div class="feature_icon">
              						<img src="img/back_office_icon.png" class="center-block img-responsive"></img>
              					</div>
                ...
                <div class="col-md-3 col-sm-6 wow fadeIn" data-wow-delay=".8s">
                    <div class="about-content">
                        ...
                        <div class="feature_icon">
                          <img src="img/iot_icon.png" class="center-block img-responsive"></img>
                        </div>
                        <h3>Hardware &amp; IOT</h3>
    ...
    <section class="bg-gray">
        <div class="container text-center wow fadeIn">
            <div class="row">
                <div class="col-lg-12">
                    <h2>How it works</h2>
                    <p>Pick the features you want from our comprehensive list to create your link, send it to your fans and customers. </p>
                    <hr class="colored">
                </div>
                <img  class="img-responsive center-block" src="img/backgrounds/bg-platform.png">  </img>
    ...
    <aside class="cta-quote" style="background-image: url('img/backoffice/bg-backoffice.jpg');">
        <div class="container wow fadeIn">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <span class="quote">The back-office iPad app lets you <span class="text-primary">manage</span>  all your features, content, customer relations completely <span class="text-primary"> self-service.</span></span>
                    <hr class="colored">
                    <a href="#backofficeModal1" data-toggle="modal" class="btn btn-outline-light">Back-office app <i class="fa fa-long-arrow-right fa-fw"></i></a>
                </div>
            </div>
        </div>
    </aside>
    ...
    <section class="portfolio-carousel wow fadeIn">
        ...
        <div class="item" style="background-image: url('img/portfolio/carousel/bg-chalkboards.jpg')">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-7 col-md-pull-5 hidden-xs">
                        <div class="device-container">
                            <div class="device-mockup macbook portrait black">
                                <div class="device">
                                    <div class="screen">
                                        <img src="img/portfolio/carousel/screen-chalkboards.png" class="img-responsive" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="item" style="background-image: url('img/portfolio/carousel/bg-pree.jpg')">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-5 col-md-push-7">
                        <div class="project-details">
                            <span class="project-name">Pree</span>
                            <span class="project-description">A Question/answer game</span>
                            <hr class="colored">
                    ...
                    <div class="col-md-7 col-md-pull-5 hidden-xs">
                        <div class="device-container">
                            <div class="device-mockup macbook portrait black">
                                <div class="device">
                                    <div class="screen">
                                        <img src="img/portfolio/carousel/screen-pree.png" class="img-responsive" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="item" style="background-image: url('img/portfolio/carousel/bg-medicuris.jpg')">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-5 col-md-push-7">
                        <div class="project-details">
                            <span class="project-name">Medicuris</span>
                            <span class="project-description">Secure healthcare with IOT</span>
                            <hr class="colored">
                    ...
                    <div class="col-md-7 col-md-pull-5 hidden-xs">
                        <div class="device-container">
                            <div class="device-mockup macbook portrait black">
                                <div class="device">
                                    <div class="screen">
                                        <img src="img/portfolio/carousel/screen-medicuris.png" class="img-responsive" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="item" style="background-image: url('img/portfolio/carousel/bg-mbb.jpg')">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-5 col-md-push-7">
                        <div class="project-details">
                    ...
                    <div class="col-md-7 col-md-pull-5 hidden-xs">
                        <div class="device-container">
                            <div class="device-mockup macbook portrait black">
                                <div class="device">
                                    <div class="screen">
                                        <img src="img/portfolio/carousel/screen-mbb.png" class="img-responsive" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div id="portfoliolist">
                        ...
                        <div class="mix identity" href="img/portfolio/grid/grid-1.jpg" title="Client Name">
                            <div class="portfolio-wrapper">
                                <img src="img/portfolio/grid/grid-1.jpg" alt="">
                                <div class="caption">
                         ...
                         <div class="mix web" href="img/portfolio/grid/grid-2.jpg" title="Client Name">
                            <div class="portfolio-wrapper">
                                <img src="img/portfolio/grid/grid-2.jpg" alt="">
                                <div class="caption">
                                    <div class="caption-text">
                                        <a class="text-title">Client Name</a>
                         ...
                         <div class="mix web" href="img/portfolio/grid/grid-3.jpg" title="Client Name">
                            <div class="portfolio-wrapper">
                                <img src="img/portfolio/grid/grid-3.jpg" alt="">
                                <div class="caption">
                                    <div class="caption-text">
                                        <a class="text-title">Client Name</a>
                                        <span class="text-category">Web Development</span>
                         ...
                         <div class="mix identity" href="img/portfolio/grid/grid-4.jpg" title="Client Name">
                            <div class="portfolio-wrapper">
                                <img src="img/portfolio/grid/grid-4.jpg" alt="">
                                <div class="caption">
                                    <div class="caption-text">
                                        <a class="text-title">Client Name</a>
                                        <span class="text-category">Brand Identity</span>
                         ...
                         <div class="mix web" href="img/portfolio/grid/grid-5.jpg" title="Client Name">
                            <div class="portfolio-wrapper">
                                <img src="img/portfolio/grid/grid-5.jpg" alt="">
                                <div class="caption">
                                    <div class="caption-text">
                                        <a class="text-title">Client Name</a>
                                        <span class="text-category">Web Development</span>
                         ...
                         <div class="mix graphic" href="img/portfolio/grid/grid-6.jpg" title="Client Name">
                            <div class="portfolio-wrapper">
                                <img src="img/portfolio/grid/grid-6.jpg" alt="">
                                <div class="caption">
                                    <div class="caption-text">
                                        <a class="text-title">Client Name</a>
                         ...
                         <div class="mix graphic" href="img/portfolio/grid/grid-7.jpg" title="Client Name">
                            <div class="portfolio-wrapper">
                                <img src="img/portfolio/grid/grid-7.jpg" alt="">
                                <div class="caption">
                                    <div class="caption-text">
                                        <a class="text-title">Client Name</a>
                                        <span class="text-category">Graphic Design</span>
                         ...
                         <div class="mix web" href="img/portfolio/grid/grid-8.jpg" title="Client Name">
                            <div class="portfolio-wrapper">
                                <img src="img/portfolio/grid/grid-8.jpg" alt="">
                                <div class="caption">
                                    <div class="caption-text">
                                        <a class="text-title">Client Name</a>
                                        <span class="text-category">Web Development</span>
                         ...
                         <div class="mix identity" href="img/portfolio/grid/grid-9.jpg" title="Client Name">
                            <div class="portfolio-wrapper">
                                <img src="img/portfolio/grid/grid-9.jpg" alt="">
                                <div class="caption">
                                    <div class="caption-text">
                                        <a class="text-title">Client Name</a>
                                        <span class="text-category">Brand Identity</span>
                        ...
                        <div class="item">
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="testimonial-info">
                                        <div class="testimonial-img">
                                            <img src="img/testimonials/2.jpg" class="img-circle img-responsive" alt="">
                                        </div>
                                        <div class="testimonial-author">
  ...
  -->
    <!-- Pricing Section -->
    <!--
    <section id="pricing" class="pricing" style="background-image: url('img/backgrounds/bg-pricing.jpg')">
        <div class="container wow fadeIn">
            <div class="row text-center">
                <div class="col-lg-12">
                    <h2>Pricing</h2>
  ...
  -->
    <!-- Footer -->
    <footer class="footer" style="background-image: url('img/backgrounds/bg-footer.jpg')">
        <div class="container text-center">
            <div class="row">
    ...
    <!-- Backoffice  Modals -->
    <!-- Example Modal 1: Corresponds with Backoffice Carousel Item 1 -->
    <div class="portfolio-modal modal fade" id="backofficeModal1" tabindex="-1" role="dialog" aria-hidden="true" style="background-image: url('img/backoffice/bg-backoffice.jpg')">
                    ...
                    <div class="row">
                                ...
                                <div class="device">
                                    <div class="screen">
                                        ...
                                        <div class="mockup-carousel">
                                            <div class="item">
                                                <img src="img/backoffice/screen-backoffice-a.png" class="img-responsive" alt="">
                                            </div>
                                            <!-- add more items -->
                                        </div>
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <ul class="list-inline item-details">
                                <li>Client: <strong>(self)</strong>
                                </li>
                                <li>Date: <strong>Oct 2015</strong>
                                </li>
                                <li>Service: <strong>Full stack development</strong>
                                </li>
                            </ul>
    ...
    <div class="portfolio-modal modal fade" id="portfolioModal1" tabindex="-1" role="dialog" aria-hidden="true" style="background-image: url('img/portfolio/carousel/bg-chalkboards.jpg')">
        <div class="modal-content">
            <div class="close-modal" data-dismiss="modal">
                <div class="lr">
                    <div class="rl">
                    ...
                    <div class="row">
                            ...
                            <div class="device-mockup macbook portrait black">
                                <div class="device">
                                    <div class="screen">
                                        ...
                                        <div class="mockup-carousel">
                                            <div class="item">
                                                <img src="img/portfolio/carousel/screen-chalkboards-a.jpg" class="img-responsive" alt="">
                                            </div>
                                            <!-- add more items -->
                                        </div>
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <ul class="list-inline item-details">
                                ...
                                <li>Date: <strong>Nov 2016</strong>
                                </li>
                                <li>Service: <strong>Full stack development</strong>
                                </li>
                            </ul>
                            <p>
                            <a target="_blank" href="http://chalkboardstoday.com">http://chalkboardstoday.com</a>
                            </p>
                            <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
                        </div>
                    </div>
    ...
    <div class="portfolio-modal modal fade" id="portfolioModal2" tabindex="-1" role="dialog" aria-hidden="true" style="background-image: url('img/portfolio/carousel/bg-pree.jpg')">
        <div class="modal-content">
            <div class="close-modal" data-dismiss="modal">
                <div class="lr">
                    <div class="rl">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h2>Pree</h2>
                            <hr class="colored">
                            <p>Pree lets you ask questions and get answers and insights. Insignts include analytics as well as social metrics. You can also make predictions and let others join the game.</p>
                        </div>
                        <div class="col-md-8 col-md-offset-2">
                            <div class="device-mockup macbook portrait black">
                                <div class="device">
                                    <div class="screen">
                                        ...
                                        <!-- Modal Mockup Option 1: Single Image (Uncomment Below to Use) -->
                                        <!-- <img src="img/portfolio/carousel/screen-2a.jpg" class="img-responsive" alt=""> -->

                                        <!-- Modal Mockup Option 2: Carousel (Example In Use Below) -->
                                        <div class="mockup-carousel">
                                            <div class="item">
                                                <img src="img/portfolio/carousel/screen-pree-a.jpg" class="img-responsive" alt="">
                                            </div>
                                        </div>
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <ul class="list-inline item-details">
                                <li>Client: <strong>Pree Media Inc.</strong>
                                </li>
                                <li>Date: <strong>Oct 2016</strong>
                                </li>
                                <li>Service: <strong>Full stack development</strong>
                                </li>
                            </ul>
                            <p>
                            <a target="_blank" href="http://pree.it">http://pree.it</a>
                            </p>
                            <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
                        </div>
                    </div>
    ...
    <div class="portfolio-modal modal fade" id="portfolioModal3" tabindex="-1" role="dialog" aria-hidden="true" style="background-image: url('img/portfolio/carousel/bg-medicuris.jpg')">
        <div class="modal-content">
            <div class="close-modal" data-dismiss="modal">
                <div class="lr">
                    <div class="rl">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h2>Medicuris</h2>
                            <hr class="colored">
                            <p>Medicuris lets hospitals and doctors reach patients for patient-reported outcome surveyes, gather responses via integrated IOT devices, and do it all with the ultimate privacy and security.</p>
                        </div>
                        <div class="col-md-8 col-md-offset-2">
                            <div class="device-mockup macbook portrait black">
                                <div class="device">
                                    <div class="screen">
                                        ...
                                        <!-- Modal Mockup Option 1: Single Image (Uncomment Below to Use) -->
                                        <!-- <img src="img/portfolio/carousel/screen-3a.jpg" class="img-responsive" alt=""> -->

                                        <!-- Modal Mockup Option 2: Carousel (Example In Use Below) -->
                                        <div class="mockup-carousel">
                                            <div class="item">
                                                <img src="img/portfolio/carousel/screen-medicuris-a.jpg" class="img-responsive" alt="">
                                            </div>
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <ul class="list-inline item-details">
                                ...
                                <li>Date: <strong>Mar 2017</strong>
                                </li>
                                <li>Service: <strong>Full stack development</strong>
                                </li>
                            </ul>
                            <p>
                            <a target="_blank" href="http://medicuris.com">http://medicuris.com</a>
                            </p>
                            <button type="button" class="btn btn-default" data-dismiss="modal"><i class="fa fa-times"></i> Close</button>
                        </div>
                    </div>
    ...
    <div class="portfolio-modal modal fade" id="portfolioModal4" tabindex="-1" role="dialog" aria-hidden="true" style="background-image: url('img/portfolio/carousel/bg-mbb.jpg')">
        <div class="modal-content">
            <div class="close-modal" data-dismiss="modal">
                <div class="lr">
                    <div class="rl">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h2>GhostRunner </h2>
                            <hr class="colored">
                            <p>GhostRunner is  a matchup baseball game where you form your own team by selecting historically accurate players and then invite a friend to play against your team. </p>
                        </div>
                        <div class="col-md-8 col-md-offset-2">
                            <div class="device-mockup macbook portrait black">
                                <div class="device">
                                    <div class="screen">
                                        ...
                                        <img src="img/portfolio/carousel/screen-mbb-a.jpg" class="img-responsive" alt="">
                        ...
                        <div class="col-md-8 col-md-offset-2">
                            <ul class="list-inline item-details">
                                <li>Client: <strong>GhostRunner Inc.</strong>
                                </li>
                                <li>Date: <strong>Jan 2017</strong>
                                </li>
                                <li>Service: <strong>Full Stack Development</strong>
                                </li>
                            </ul>
